    ...
    <div class="footer-content p-relative mt-section">
        ...
        <div class="text-center container">
            ...
            <div class="dsn-icon-heading-color dsn-def-btn d-flex justify-content-center mt-30">
                <a class="dsn-btn dsn-border border-color-default  background-main  effect-ajax has-icon-left"
                    href="{{route('contact_mail')}}" data-dsn-text="START A PROJECT">
        ...
        <div class="dsn-container pt-60">
            <div class="d-grid grid-lg-4 grid-md-2 ">
                    ...
                    <div class="dsn-logo main-logo">
                        <div class="main-logo">
                            <a href="#" data-dsn-text="Thamoddya"
                                ...
                                <img class="custom-logo logo-light" src="assets/img/logo-light.png" alt="Thamoddya" />
                                <img class="custom-logo logo-dark" src="assets/img/logo.png" alt="Thamoddya" />
                            </a>
                        </div>
                    </div>
                ...
                <div class="grid-col-2">
                    ...
                    <div class="menu-footer-menu-container">
                        <ul id="menu-footer-menu" class="menu">
                            <li class="menu-item">
                                <a href="#" class="effect-ajax">HOME</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="effect-ajax">PORTFOLIO</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://blog.thamoddya.cloud/" class="effect-ajax">BLOG</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="effect-ajax">CONTACT</a>
                            </li>
                ...
                <div class="grid-col-3">
                    ...
                    <div class="col-contact">
                        <p><strong>T</strong> : +94 76 945 8554</p>
                        <p class="mt-10"><strong>F</strong> :Thamoddya Rashmitha</p>
                        <p class="over-hidden mt-10">
                            <strong>E</strong> : <a class="link-hover" href="#"
                                data-hover-text="contact@thamoddya.cloud">contact@thamoddya.cloud</a>
                        </p>
                    </div>
            ...
            <div class="footer-bottom mt-60 pt-30 border-top pb-30 text-center">
                <p class="over-hidden">
                    &copy; {{ date('Y') }} by
                    <a href="#0" class="link-hover" data-hover-text="DSN Grid" target="_blank">Thamoddya Rashmitha</a>
                </p>
            </div>
        </div>
