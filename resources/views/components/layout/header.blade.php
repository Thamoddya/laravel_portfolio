<header id="site_menu_header" class="site-header  dsn-container d-none dsn-hamburger">
    ...
    <nav class="main-navigation ">
        <div class="menu-cover-title header-container dsn-container">THAMODDYA</div>
            ...
            <div class="nav__info">
                ...
                <div class="nav-content mt-30">
                    ...
                    <p class="links over-hidden mb-1">
                        <a class="link-hover d-block" href="tel:00201004392260" data-hover-text="+94 769458554">+94
                            76 945 8554</a>
                    </p>
                    <p class="links over-hidden"><a class="link-hover" href="mailto:thamoddyarashmithadissanayake@gmail.com"
                            data-hover-text="info@dsngrid.com">thamoddyarashmithadissanayake@gmail.com</a></p>
                    <p class="links over-hidden"><a class="link-hover" href="mailto:thamoddya.working@gmail.com"
                            data-hover-text="info@dsngrid.com">thamoddya.working@gmail.com</a></p>
            ...
            <div class="nav-social nav-content mt-30">
                <div class="nav-social-inner p-relative">
                    ...
                    <ul style="--dsn-li-name: dsn6;">
                        <li style="--dsn-li-index: 0;"><a href="https://youtube.com/@thamoddyarashmitha4352" target="_blank"
                                rel="nofollow noopener noreferrer">YouTube.</a></li>
                        <li style="--dsn-li-index: 1;"><a href="https://facebook.com/Thamoddya" target="_blank"
                                rel="nofollow noopener noreferrer">Facebook.</a></li>
                        <li style="--dsn-li-index: 2;"><a href="https://www.linkedin.com/in/thamoddya-rashmitha/" target="_blank"
