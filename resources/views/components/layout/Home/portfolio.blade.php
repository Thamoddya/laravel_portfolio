...
<div class="p-relative pb-section over-hidden box-shadow-image box-image-transform dsn-style-cards ">
    <div class="root-posts">
        <div class="dsn-grid-layout dsn-grid dsn-posts dsn-post-type-cards use-horizontal-scroll box-image-normal v-dark-head"
            data-dsn-option='{"speed":15,"start":"0"}'>
            <article class="dsn-item-post start-section  grid-item p-relative v-light">

                <h2 class="dsn-animate-up letter-stroke">My </h2>
                    ...
                    <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                        <div class="post-title-info">
                            ...
                            <p class="section_description mt-15 max-w570 ">
                                This Project was done for Sahan Induwara, For his grade 6 to 11 Science students. Use
                                HTML/CSS and JS FrontEnd and PHP backend with MySql Database.
                            </p>
                        ...
                        <div class="post-title-info">
                            <div class="post-meta max-w750">
                                <div class="p-relative d-inline-block dsn-category dsn-bg metas mb-10 entry-meta">
                                    ...
                                    <span data-separator=" & ">Android & Ios</span>
                                </div>
                            </div>
                            <h2 class="post-title title-block">
                ...
                <div class="box-content d-flex ">
                    ...
                    <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                        <div class="post-title-info">
                            ...
                            <p class="section_description mt-15 max-w570 ">
                                This is my official blog website where I share my interested areas and research areas as
                ...
                <div class="box-content d-flex ">
                    ...
                    <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                        <div class="post-title-info">
                            <div class="post-meta max-w750">
                                <div class="p-relative d-inline-block dsn-category dsn-bg metas mb-10 entry-meta">
                                    <span data-separator=" & ">Education</span>
                                    <span data-separator=" & ">LMS</span>
                                </div>
                            </div>
                            <h2 class="post-title title-block">
            ...
            <article class="dsn-item-post end-section grid-item p-relative v-light">

                <h2 class="dsn-animate-up letter-stroke">Desgn &</h2>
                <h2 class="dsn-animate-down letter-stroke">Develop</h2>
