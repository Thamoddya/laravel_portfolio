<div class="about-personal container section-margin">
    <div class="box-content pt-section">
        <div class="box-content-inner background-section">
            ...
            <p class="max-w750 mt-30">
                In my craft as a software engineer, I strive to strike the perfect equilibrium between
                functionality and elegance. From intricate code structures and algorithms to the final user
                interfaces, my guiding principle is simplicity.
            </p>
                ...
                <div class="dsn-skills-item grid-item">
                    <div class="skills-inner">
                        <div class="bar-svg">
                            ...
                            <h5 class="dsn-title-award sm-title-block mt-30">Communication and Collaboration</h5>
                        </div>
                    </div>
                </div>
                <div class="dsn-skills-item grid-item">
                    <div class="skills-inner">
                        <div class="bar-svg">
                            ...
                            <h5 class="dsn-title-award sm-title-block mt-30">Software/Web Development Tools and
                                Technologies</h5>
                        </div>
                    </div>
                </div>
                <div class="dsn-skills-item grid-item">
                    <div class="skills-inner">
                        <div class="bar-svg">
                            ...
                            <h5 class="dsn-title-award sm-title-block mt-30">Problem-Solving and Algorithmic Skills</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="box-img p-relative">
        <div class="img-box-parallax before-z-index" data-dsn="parallax" data-overlay="0">
            <img src='assets/img/p-1.jpg' class="cover-bg-img" alt='' />
        </div>
    </div>
</div>
